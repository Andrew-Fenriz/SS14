...
petting-success-trashbot = You pet {THE($target)} on {POSS-ADJ($target)} dirty metal head.
...
petting-failure-trashbot = You try to pet {THE($target)}, but {SUBJECT($target)} {CONJUGATE-BE($target)} too busy compacting trash!
