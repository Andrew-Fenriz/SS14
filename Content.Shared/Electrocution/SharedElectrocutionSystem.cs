...
public abstract partial class SharedElectrocutionSystem : EntitySystem
{
    ...
    /// </summary>
    public void SetElectrified(Entity<Components.ElectrifiedComponent> ent, bool value)
    {
    ...
    public void SetElectrifiedWireCut(Entity<Components.ElectrifiedComponent> ent, bool value)
    {
    ...
    /// <param name="isElectrocutionRelay">Should the electrocution be relayed to other entities interacting with the source?</param>
