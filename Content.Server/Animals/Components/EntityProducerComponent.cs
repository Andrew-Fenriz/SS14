...
/// </summary>
/// <param name="Producer">Entity on whose behalf the entities were produced.</param>
/// <param name="Entities">Entities spawned by the successful production attempt.</param>
[ByRefEvent]
public readonly record struct EntitiesProducedEvent(EntityUid Producer, IReadOnlyList<EntityUid> Entities);
